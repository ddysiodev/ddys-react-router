...
const exampleRoutes = [
  ...
  'api.ddys.proxy.ts','api.ddys.request.ts','api.ddys.diagnostics.ts','api.ddys.revalidate.ts','sitemap.xml.ts','robots.txt.ts','manifest.webmanifest.ts','favicon.ico.ts'
